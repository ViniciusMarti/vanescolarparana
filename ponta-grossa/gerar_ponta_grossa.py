...
CITY_SLUG = "ponta-grossa"
BASE_DIR = r'C:\Users\marti\Documents\Projetos\vanescolarparana\ponta-grossa'
BASE_URL = "https://www.vanescolarparana.com"

# Lista de bairros fornecida
bairros = [
    "Centro", "Uvaranas", "Oficinas", "Olarias", "Nova Rússia", 
    "Contorno", "Boa Vista", "Cará-Cará", "Chapada", 
    "Colônia Dona Luiza", "Neves", "Ronda"
]

def slugify(text):
    """Transforma 'Nova Rússia' em 'nova-russia'"""
...
def criar_bairros():
    """Gera cada arquivo bairro.html diretamente na pasta de Ponta Grossa"""
    for b in bairros:
        slug = slugify(b)
