  ...
  <main>
    <section class="hero-gradient text-white pt-24 pb-24 relative overflow-hidden">
      <div class="container mx-auto px-6 lg:px-12 text-center relative z-10">
        ...
        <p class="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto font-medium leading-relaxed">Conectamos pais e transportadores em Ponta Grossa com segurança. Localize o bairro atendido e entre em contato.</p>
      </div>
    ...
    <section class="py-20 bg-slate-50 border-b border-slate-200">
      <div class="container mx-auto px-6 lg:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
          <a href="/ponta-grossa/uvaranas/" class="featured-card group relative block overflow-hidden rounded-[2.5rem] shadow-xl h-[30rem] bg-gradient-to-br from-blue-700 to-indigo-900">
            <div class="absolute inset-0 flex items-center justify-center opacity-10"><span class="text-[12rem] font-black text-white">UV</span></div>
            <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
            <div class="absolute bottom-0 p-10"><h3 class="text-3xl font-black text-white mb-4">Uvaranas</h3><p class="text-gray-200 text-lg font-medium leading-relaxed opacity-90">Um dos maiores e mais populosos bairros, com grande concentração de escolas e campus universitário.</p></div>
          </a>
          <a href="/ponta-grossa/nova-russia/" class="featured-card group relative block overflow-hidden rounded-[2.5rem] shadow-xl h-[30rem] bg-gradient-to-br from-slate-700 to-slate-900">
            <div class="absolute inset-0 flex items-center justify-center opacity-10"><span class="text-[12rem] font-black text-white">NR</span></div>
            <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
            <div class="absolute bottom-0 p-10"><h3 class="text-3xl font-black text-white mb-4">Nova Rússia</h3><p class="text-gray-200 text-lg font-medium leading-relaxed opacity-90">Bairro tradicional e comercial, ponto estratégico para diversas rotas de transporte escolar.</p></div>
          </a>
          <a href="/ponta-grossa/centro/" class="featured-card group relative block overflow-hidden rounded-[2.5rem] shadow-xl h-[30rem] bg-gradient-to-br from-blue-800 to-slate-900">
            <div class="absolute inset-0 flex items-center justify-center opacity-10"><span class="text-[12rem] font-black text-white">CT</span></div>
            <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
            <div class="absolute bottom-0 p-10"><h3 class="text-3xl font-black text-white mb-4">Centro</h3><p class="text-gray-200 text-lg font-medium leading-relaxed opacity-90">O coração de Ponta Grossa, conectando todos os cantos da cidade com eficiência.</p></div>
          </a>
        </div>
      </div>
    </section>
