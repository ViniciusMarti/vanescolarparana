      ...
      <div class="container mx-auto px-6 lg:px-12 text-center relative z-10">
        ...
        <div class="max-w-2xl mx-auto relative group">
          ...
          <input 
            type="text" 
            id="city-search"
            placeholder="Buscar bairro em Maringá..." 
    ...
    <section class="py-12 bg-slate-50 border-b border-slate-200">
      <div class="container mx-auto px-4 lg:px-12">
        ...
        <div class="flex md:grid md:grid-cols-3 gap-6 overflow-x-auto pb-6 md:pb-0 snap-x hide-scrollbar">
          <!-- Zona 01 -->
          <a href="/maringa/zona-01/" class="featured-card group relative block overflow-hidden rounded-[2rem] md:rounded-[2.5rem] shadow-xl h-[24rem] md:h-[30rem] min-w-[85%] md:min-w-0 snap-center shrink-0 bg-slate-200">
            ...
            <div class="absolute bottom-0 p-8">
              <h3 class="text-2xl md:text-3xl font-black text-white mb-2">Zona 01</h3>
              <p class="text-gray-200 text-sm md:text-lg font-medium leading-relaxed opacity-90">O centro cívico e comercial.</p>
            </div>
          </a>
          <!-- Vila Morangueira -->
          <a href="/maringa/vila-morangueira/" class="featured-card group relative block overflow-hidden rounded-[2rem] md:rounded-[2.5rem] shadow-xl h-[24rem] md:h-[30rem] min-w-[85%] md:min-w-0 snap-center shrink-0 bg-slate-200">
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
            <div class="absolute bottom-0 p-8">
              <h3 class="text-2xl md:text-3xl font-black text-white mb-2">Vila Morangueira</h3>
              <p class="text-gray-200 text-sm md:text-lg font-medium leading-relaxed opacity-90">Região tradicional e familiar.</p>
            </div>
          </a>
          <!-- Jardim Alvorada -->
          <a href="/maringa/jardim-alvorada/" class="featured-card group relative block overflow-hidden rounded-[2rem] md:rounded-[2.5rem] shadow-xl h-[24rem] md:h-[30rem] min-w-[85%] md:min-w-0 snap-center shrink-0 bg-slate-200">
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
            <div class="absolute bottom-0 p-8">
              <h3 class="text-2xl md:text-3xl font-black text-white mb-2">Jardim Alvorada</h3>
              <p class="text-gray-200 text-sm md:text-lg font-medium leading-relaxed opacity-90">Bairro vibrante e populoso.</p>
            </div>
          </a>
        </div>
      </div>
