  ...
  <main>
    <section class="hero-gradient text-white pt-24 pb-24 relative overflow-hidden">
      <div class="container mx-auto px-6 lg:px-12 text-center relative z-10">
        <h1 class="text-4xl md:text-6xl font-extrabold mb-6 leading-tight">Vans Escolares em <?php echo $cidade_nome; ?></h1>
        <p class="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto font-medium leading-relaxed">Conectamos pais e transportadores em Maringá com segurança e eficiência. Escolha o bairro e fale com o motorista agora.</p>
      </div>
    ...
    <section class="py-20 bg-slate-50 border-b border-slate-200">
      <div class="container mx-auto px-6 lg:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
          <a href="/maringa/zona-01/" class="featured-card group relative block overflow-hidden rounded-[2.5rem] shadow-xl h-[30rem] bg-slate-200">
            <img src="/images/bairros/maringa-zona-01.png" alt="Zona 01" class="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-110" />
            <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
            <div class="absolute bottom-0 p-10"><h3 class="text-3xl font-black text-white mb-4">Zona 01</h3><p class="text-gray-200 text-lg font-medium leading-relaxed opacity-90">O centro cívico e comercial de Maringá, ponto central de rotas escolares e serviços.</p></div>
          </a>
          <a href="/maringa/vila-morangueira/" class="featured-card group relative block overflow-hidden rounded-[2.5rem] shadow-xl h-[30rem] bg-slate-200">
            <img src="/images/bairros/maringa-vila-morangueira.png" alt="Vila Morangueira" class="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-110" />
            <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
            <div class="absolute bottom-0 p-10"><h3 class="text-3xl font-black text-white mb-4">Vila Morangueira</h3><p class="text-gray-200 text-lg font-medium leading-relaxed opacity-90">Região tradicional com forte demanda por transporte escolar e ambiente familiar.</p></div>
          </a>
          <a href="/maringa/jardim-alvorada/" class="featured-card group relative block overflow-hidden rounded-[2.5rem] shadow-xl h-[30rem] bg-slate-200">
            <img src="/images/bairros/maringa-jardim-alvorada.png" alt="Jardim Alvorada" class="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-110" />
            <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
            <div class="absolute bottom-0 p-10"><h3 class="text-3xl font-black text-white mb-4">Jardim Alvorada</h3><p class="text-gray-200 text-lg font-medium leading-relaxed opacity-90">Um dos bairros mais vibrantes e populosos, com vasta rede de vans escolares.</p></div>
          </a>
        </div>
      </div>
    </section>
