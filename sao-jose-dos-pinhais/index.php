  ...
  <main>
    ...
    <section class="hero-gradient text-white pt-16 pb-16 relative overflow-hidden">
      <div class="container mx-auto px-6 lg:px-12 text-center relative z-10">
        <h1 class="text-2xl md:text-4xl lg:text-5xl font-black leading-tight mb-6">Vans Escolares em S. J. dos Pinhais</h1>
        <p class="text-base md:text-xl text-blue-100 max-w-3xl mx-auto font-medium leading-relaxed mb-10">Localize o transporte escolar ideal na Região Metropolitana. Segurança para seus filhos.</p>
        ...
        <div class="max-w-2xl mx-auto relative group">
          ...
          <input 
            type="text" 
            id="city-search"
            placeholder="Buscar bairro em S. J. dos Pinhais..." 
    ...
    <section class="py-12 bg-slate-50 border-b border-slate-200">
      <div class="container mx-auto px-4 lg:px-12">
        ...
        <div class="flex md:grid md:grid-cols-3 gap-6 overflow-x-auto pb-6 md:pb-0 snap-x hide-scrollbar">
          <!-- Afonso Pena -->
          <a href="/sao-jose-dos-pinhais/afonso-pena/" class="featured-card group relative block overflow-hidden rounded-[2rem] md:rounded-[2.5rem] shadow-xl h-[24rem] md:h-[30rem] min-w-[85%] md:min-w-0 snap-center shrink-0 bg-gradient-to-br from-blue-600 to-indigo-900">
            <div class="absolute inset-0 flex items-center justify-center opacity-10"><span class="text-[10rem] font-black text-white">AP</span></div>
            <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
            <div class="absolute bottom-0 p-8">
              <h3 class="text-2xl md:text-3xl font-black text-white mb-2">Afonso Pena</h3>
              <p class="text-gray-200 text-sm md:text-lg font-medium leading-relaxed opacity-90">Principal polo industrial e residencial.</p>
            </div>
          </a>
          <!-- Centro -->
          <a href="/sao-jose-dos-pinhais/centro/" class="featured-card group relative block overflow-hidden rounded-[2rem] md:rounded-[2.5rem] shadow-xl h-[24rem] md:h-[30rem] min-w-[85%] md:min-w-0 snap-center shrink-0 bg-gradient-to-br from-slate-700 to-slate-900">
            <div class="absolute inset-0 flex items-center justify-center opacity-10"><span class="text-[10rem] font-black text-white">SJ</span></div>
            <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
            <div class="absolute bottom-0 p-8">
              <h3 class="text-2xl md:text-3xl font-black text-white mb-2">Centro</h3>
              <p class="text-gray-200 text-sm md:text-lg font-medium leading-relaxed opacity-90">Facilidade de acesso e conexão.</p>
            </div>
          </a>
          <!-- Cidade Jardim -->
          <a href="/sao-jose-dos-pinhais/cidade-jardim/" class="featured-card group relative block overflow-hidden rounded-[2rem] md:rounded-[2.5rem] shadow-xl h-[24rem] md:h-[30rem] min-w-[85%] md:min-w-0 snap-center shrink-0 bg-gradient-to-br from-blue-800 to-slate-900">
            <div class="absolute inset-0 flex items-center justify-center opacity-10"><span class="text-[10rem] font-black text-white">CJ</span></div>
            <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
            <div class="absolute bottom-0 p-8">
              <h3 class="text-2xl md:text-3xl font-black text-white mb-2">Cidade Jardim</h3>
              <p class="text-gray-200 text-sm md:text-lg font-medium leading-relaxed opacity-90">Região valorizada e familiar.</p>
            </div>
          </a>
        </div>
      </div>
