...
CITY_NAME = "Londrina"
CITY_SLUG = "londrina"
BASE_DIR = r'C:\Users\marti\Documents\Projetos\vanescolarparana\londrina'
BASE_URL = "https://www.vanescolarparana.com"

# Lista de bairros fornecida
bairros = [
    "Aeroporto", "Bandeirantes", "Bela Suíça", "Cafézal", "Catuai", "Centro", 
    "Chefe Newton", "Coliseu", "Ernani Moura Lima", "Gleba Palhano", "Graciosa", 
    "Higienópolis", "Ideal", "Interlagos", "Jardim Alvorada", "Jardim Califórnia", 
    "Jardim Cláudia", "Jardim do Lago", "Jardim Europa", "Jardim Imagawa", 
    "Jardim Leonor", "Jardim Lindóia", "Jardim Maringá", "Jardim Piza", 
    "Jardim Sabará", "Jardim Santo Amaro", "Jardim Shangri-lá", "Jardim Tarumã", 
    "Jardim Tucanos", "Leonor", "Monte Belo", "Ouro Branco", "Palhano", 
    "Parque Guanabara", "Parque Jamaica", "Parque Ouro Branco", 
    "Parque Residencial do Café", "Parque Tauá", "Piza", "Quebec", "Sabará", 
    "Santa Rita", "Santo Antônio", "Tucanos", "União da Vitória", "Vivendas do Arvoredo"
]

def slugify(text):
    """Transforma 'Bela Suíça' em 'bela-suica'"""
...
def criar_index():
    """Gera o index.html de Londrina com o grid de bairros"""
    links_html = ""
...
def criar_bairros():
    """Gera cada arquivo bairro.html diretamente na pasta de Londrina"""
    for b in bairros:
        slug = slugify(b)
    ...
    <div class="flex flex-col min-h-screen">
        <header class="bg-white/90 backdrop-blur border-b border-gray-100 sticky top-0 z-50">
            <nav class="container mx-auto flex h-16 items-center justify-between px-4">
                ...
                <div class="flex items-center gap-4">
                    <a class="hidden sm:inline text-gray-600 font-medium" href="/informativos/">Informativos</a>
                    <a class="rounded-xl bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow" href="/destaque-sua-van/">Destaque sua Van</a>
                </div>
            </nav>
        </header>
...
if __name__ == "__main__":
    ...
    criar_index()
    criar_bairros()
    print(f"✅ Estrutura de {CITY_NAME} (Padronizada) criada com sucesso!")