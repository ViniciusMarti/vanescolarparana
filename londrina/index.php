  ...
  <main>
    ...
    <section class="hero-gradient text-white pt-16 pb-16 relative overflow-hidden">
      <div class="container mx-auto px-6 lg:px-12 text-center relative z-10">
        <h1 class="text-2xl md:text-4xl lg:text-5xl font-black mb-6 leading-tight">Vans Escolares em <?php echo $cidade_nome; ?></h1>
    ...
    <section class="py-12 bg-slate-50 border-b border-slate-200">
      <div class="container mx-auto px-4 lg:px-12">
        ...
        <div class="flex md:grid md:grid-cols-3 gap-6 overflow-x-auto pb-6 md:pb-0 snap-x hide-scrollbar">
          <!-- Gleba Palhano -->
          <a href="/londrina/gleba-palhano/" class="featured-card group relative block overflow-hidden rounded-[2rem] md:rounded-[2.5rem] shadow-xl h-[24rem] md:h-[30rem] min-w-[85%] md:min-w-0 snap-center shrink-0 bg-slate-200">
            ...
            <div class="absolute bottom-0 p-8">
              <h3 class="text-2xl md:text-3xl font-black text-white mb-2">Gleba Palhano</h3>
              <p class="text-gray-200 text-sm md:text-lg font-medium leading-relaxed opacity-90">A região mais moderna de Londrina.</p>
            </div>
          </a>
          <!-- Centro -->
          <a href="/londrina/centro/" class="featured-card group relative block overflow-hidden rounded-[2rem] md:rounded-[2.5rem] shadow-xl h-[24rem] md:h-[30rem] min-w-[85%] md:min-w-0 snap-center shrink-0 bg-slate-200">
            ...
            <div class="absolute bottom-0 p-8">
              ...
              <p class="text-gray-200 text-sm md:text-lg font-medium leading-relaxed opacity-90">O coração da cidade e serviços.</p>
            </div>
          </a>
          <!-- Higienópolis -->
          <a href="/londrina/higienopolis/" class="featured-card group relative block overflow-hidden rounded-[2rem] md:rounded-[2.5rem] shadow-xl h-[24rem] md:h-[30rem] min-w-[85%] md:min-w-0 snap-center shrink-0 bg-slate-200">
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
            <div class="absolute bottom-0 p-8">
              <h3 class="text-2xl md:text-3xl font-black text-white mb-2">Higienópolis</h3>
              <p class="text-gray-200 text-sm md:text-lg font-medium leading-relaxed opacity-90">Bairro tradicional e arborizado.</p>
            </div>
          </a>
        </div>
      </div>
