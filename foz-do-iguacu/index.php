  ...
  <main>
    <section class="hero-gradient text-white pt-24 pb-24 relative overflow-hidden">
      <div class="container mx-auto px-6 lg:px-12 text-center relative z-10">
        ...
        <p class="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto font-medium leading-relaxed">Encontre o transporte escolar ideal na Terra das Cataratas. Segurança e confiança para seus filhos, direto com o motorista.</p>
      </div>
    ...
    <section class="py-20 bg-slate-50 border-b border-slate-200">
      <div class="container mx-auto px-6 lg:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
          <a href="/foz-do-iguacu/centro/" class="featured-card group relative block overflow-hidden rounded-[2.5rem] shadow-xl h-[30rem] bg-slate-200">
            <img src="/images/bairros/foz-centro.png" alt="Centro" class="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-110" />
            <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
            <div class="absolute bottom-0 p-10"><h3 class="text-3xl font-black text-white mb-4">Centro</h3><p class="text-gray-200 text-lg font-medium leading-relaxed opacity-90">O polo central de Foz do Iguaçu, com rotas que atendem aos principais colégios da cidade.</p></div>
          </a>
          <a href="/foz-do-iguacu/itaipu-a/" class="featured-card group relative block overflow-hidden rounded-[2.5rem] shadow-xl h-[30rem] bg-gradient-to-br from-blue-600 to-blue-900">
              <div class="absolute inset-0 flex items-center justify-center opacity-20"><span class="text-[15rem] font-black text-white">IA</span></div>
              <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
              <div class="absolute bottom-0 p-10"><h3 class="text-3xl font-black text-white mb-4">Itaipu A</h3><p class="text-gray-200 text-lg font-medium leading-relaxed opacity-90">Região residencial de destaque, com forte demanda por transporte escolar especializado e seguro.</p></div>
          </a>
          <a href="/foz-do-iguacu/tres-lagoas/" class="featured-card group relative block overflow-hidden rounded-[2.5rem] shadow-xl h-[30rem] bg-gradient-to-br from-slate-600 to-slate-900">
             <div class="absolute inset-0 flex items-center justify-center opacity-20"><span class="text-[15rem] font-black text-white">TL</span></div>
             <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent"></div>
             <div class="absolute bottom-0 p-10"><h3 class="text-3xl font-black text-white mb-4">Três Lagoas</h3><p class="text-gray-200 text-lg font-medium leading-relaxed opacity-90">Bairro em plena expansão, com diversas opções de transporte escolar para atender a comunidade.</p></div>
          </a>
        </div>
      </div>
    </section>
