...
CITY_SLUG = "foz-do-iguacu"
BASE_DIR = r'C:\Users\marti\Documents\Projetos\vanescolarparana\foz-do-iguaçu'
BASE_URL = "https://www.vanescolarparana.com"

# Lista de bairros fornecida
bairros = [
    "Alvorada", "América", "Bourbon", "Campos do Iguaçu", "Carimã", "Cataratas", 
    "Centro", "Centro Cívico", "Cidade Nova", "Cognópolis", "Itaipu A", "Itaipu B", 
    "Itaipu C", "Ipê", "KLP", "Lancaster", "Lote Grande", "Maracanã", "Mata Verde", 
    "Monjolo", "Morumbi", "Náutica", "Panorama", "Parque Nacional", "Polo Centro", 
    "Polo Universitário", "Portes", "Portal da Foz", "Porto Belo", "Porto Meira", 
    "Remanso", "São Roque", "Três Bandeiras", "Três Fronteiras", "Três Lagoas", "Yolanda"
]

def slugify(text):
    """Transforma 'Três Bandeiras' em 'tres-bandeiras'"""
...
def criar_index():
    """Gera o index.html da cidade seguindo o layout de Curitiba"""
    links_html = ""
    for b in sorted(bairros):
        slug = slugify(b)
        # Links apontando para arquivo.html igual Curitiba
        links_html += f"""
...
<body class="bg-gray-50 text-gray-800">
    ...
    <footer class="bg-gray-900 text-white py-12 mt-12">
        <div class="container mx-auto px-4 text-center">
            <img class="h-8 mx-auto mb-4 opacity-50 grayscale invert" src="/logo-van-escolar-parana.png"/>
            <p class="text-gray-400 text-sm">© 2026 Van Escolar Paraná. Todos os direitos reservados.</p>
        </div>
    </footer>
</body>
</html>"""
...
def criar_bairros():
    ...
    for b in bairros:
        slug = slugify(b)
        # Salva como bairro.html direto na pasta base
...
if __name__ == "__main__":
    ...
    criar_index()
    criar_bairros()
    print(f"✅ Estrutura de {CITY_NAME} (Estilo Curitiba) criada com sucesso!")